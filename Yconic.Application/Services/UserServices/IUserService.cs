...
namespace Yconic.Application.Services.UserServices
{
    public interface IUserService
    {
        ...
        Task<ApiResult<UserPersonalDto>> AddProfilePhoto(Guid id, AddProfilePhotoDto profilePhoto);

        Task<ApiResult<UserPersonalDto>> UpdateUserPersonal(Guid id, UserPersonalPatchDto user);
        ...
        Task<ApiResult<UserAccountDto>> UpdatePrivacy(Guid id);
